...
final class WindowSubsystem implements WorldSubsystem {
    ...
    WindowSubsystem(String title, int width, int height) {
        this.title = title;
        this.width = width;
        this.height = height;
    }
    ...
    WindowEvents lastEvents() { return lastEvents; }
    boolean isCloseRequested() { return closeRequested; }
